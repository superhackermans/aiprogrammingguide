...
> **What this is:** Complete, validated instructions to hand to an LLM (with the FUSO HMI HTML file as a design reference) to build a comprehensive, interactive HTML reference document that takes a complete beginner from zero programming knowledge to orchestrating multi-agent AI coding systems — structured around Bassim Eledath's "8 Levels of Agentic Engineering" framework.
>
...
>
> **Source for Levels framework:** [The 8 Levels of Agentic Engineering — Bassim Eledath](https://www.bassimeledath.com/blog/levels-of-agentic-engineering) (March 2026)
>
...
## The 8 Levels Progression (Bassim Eledath)
...
>
> **Current tool (as of March 2026):** Dispatch by Bassim Eledath. Install: `npx skills add bassimeledath/dispatch -g`. Alternatives: `claude --background`, Gas Town, Multiclaude, Ramp Inspect.
...
**Current tool (March 2026):** Dispatch by Bassim Eledath. `npx skills add bassimeledath/dispatch -g`. Workers get fresh context windows. Stuck workers surface questions.
...
**The honest assessment (Eledath):** "For day-to-day work, Level 7 is where the leverage is."
...
**The multiplayer bottleneck (Eledath):** "If you're Level 7 raising PRs while you sleep, but your reviewer is Level 2, your throughput is capped at Level 2."
...
**Closing quote (`.pq`):** "AI's coding ability is outpacing our ability to wield it effectively. The gap between capability and practice doesn't close overnight. It closes in levels. — Bassim Eledath"
